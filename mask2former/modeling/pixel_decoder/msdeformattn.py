...
class MSDeformAttnTransformerEncoder(nn.Module):
    def __init__(self, encoder_layer, num_layers):
        ...
        # self.layers -- ModuleList((0): MSDeformAttnTransformerEncoderLayer ...)
        # xxxx8888
...
class MSDeformAttnPixelDecoder(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        if self.transformer_num_feature_levels > 1:
            ...
            # transformer_in_channels[::-1] -- [2048, 1024, 512]
        ...
        for idx, in_channels in enumerate(self.feature_channels[:self.num_fpn_levels]):
            lateral_norm = get_norm(norm, conv_dim) # GroupNorm(32, 256, eps=1e-05, affine=True)
            output_norm = get_norm(norm, conv_dim) # GroupNorm(32, 256, eps=1e-05, affine=True)
    ...
    def forward_features(self, features):
        ...
        # self.transformer_in_features[::-1] -- ['res5', 'res4', 'res3']
        ...
        # self.in_features[:self.num_fpn_levels][::-1] -- ['res2']
